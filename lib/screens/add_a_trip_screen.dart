            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                      child: _buildBudgetOption('Low'),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _buildBudgetOption('Medium'),
                    ),
                    const SizedBox(width: 8),
                    Expanded(
                      child: _buildBudgetOption('High'),
                    ),
                  ],
                ),
                const SizedBox(height: 24),
                ...
                TextFormField(
                  ...
                  maxLines: 4,
                  decoration: InputDecoration(
                    hintText: 'Any extra info? e.g., "Budget-friendly trip, staying in hostels"',
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12),
                    ),
                    filled: true,
